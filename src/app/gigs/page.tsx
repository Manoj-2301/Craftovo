      ...
      <main className="flex-1">
        <section className="pt-32 pb-16 md:pt-48 md:pb-24 overflow-hidden relative">
          <Container className="relative z-10">
            <AnimateIn>
              <h1 className="font-outfit text-5xl md:text-7xl font-medium mb-6 text-white tracking-tight">Productised Gigs</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <AnimateIn key={i} delay={i * 0.1}>
                  <Card className="h-full flex flex-col border-white/[0.05] hover:border-white/20">
                    <h3 className="font-outfit text-3xl font-medium mb-4 text-white">{gig.title}</h3>
                    <div className="text-2xl text-white font-medium mb-6 pb-6 border-b border-white/10 tracking-tight">{gig.price} <span className="text-sm text-text-muted font-light tracking-normal">/ one-time</span></div>
