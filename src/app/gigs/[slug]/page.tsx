           ...
           <Container className="relative z-10">
              <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
                 ...
                 <div className="w-full lg:w-1/3 shrink-0 lg:sticky lg:top-32">
                    <AnimateIn>
                       <div className="glass-panel p-8 md:p-10 rounded-[2rem] flex flex-col items-start border-white/10">
                          <span className="inline-block px-3 py-1 rounded-full bg-white/5 text-xs font-bold tracking-widest uppercase text-text-muted mb-6">
                            {gig.category}
                          </span>
                          <h1 className="font-outfit text-3xl md:text-4xl font-medium mb-4 text-white tracking-tight">{gig.title}</h1>
                          ...
                          <div className="w-full border-t border-white/10 pt-8 mb-8">
                             ...
                             <div className="text-4xl font-medium text-white">{gig.startingPrice}</div>
                          </div>

                          <div className="grid grid-cols-2 gap-4 w-full mb-8">
                             <div className="bg-white/5 rounded-xl p-4">
                               <div className="text-xs text-text-muted uppercase tracking-wider mb-1">Delivery</div>
                               <div className="font-medium text-white">{gig.deliveryDays}</div>
                             </div>
                             <div className="bg-white/5 rounded-xl p-4">
                               <div className="text-xs text-text-muted uppercase tracking-wider mb-1">Revisions</div>
                               <div className="font-medium text-white">{gig.revisions}</div>
                             </div>
                          </div>
                 ...
                 <div className="w-full lg:w-2/3 flex flex-col gap-16">
                    <AnimateIn delay={0.1}>
                       <h2 className="font-outfit text-3xl md:text-4xl font-medium mb-8 text-white">What's included</h2>
                       <ul className="flex flex-col gap-4">
                         {gig.features.map((feature, i) => (
                            <li key={i} className="flex items-start gap-4">
                               <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center shrink-0 mt-0.5 text-white">
                    ...
                    <AnimateIn delay={0.2}>
                       <h2 className="font-outfit text-3xl md:text-4xl font-medium mb-8 text-white">How it works</h2>
                          ...
                          {[
                            ...
                            { step: '03', title: 'Delivery & Handoff', desc: 'Final review, testing, and handover of the completed project.' }
                             ...
                             <div key={i} className="flex gap-6 md:gap-8 items-start">
                                <div className="font-outfit text-4xl md:text-5xl font-light text-white/20">{item.step}</div>
